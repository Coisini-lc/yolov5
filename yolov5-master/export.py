...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "D:/Learning/yolo/yolov5-master/yolov5-master/runs/train\exp8\weights/best.pt", help="model.pt path(s)")
